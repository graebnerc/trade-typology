...
replication_dta <- do_clustering(cluster_data_DTA_normed1994, 
                                 cluster_vars, 
                                 n_groups)
