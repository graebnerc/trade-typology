# Date: May 7 2019
# This file compares the clustering results for 3 kinds of data: 
# The data used by Dennis. The raw data used by Dennis, processed in R.
# The original data, fully processed in R.
# Since now it is clear that all yield the same result, a new final dataset
# is saved, and the creation of this data set is conducted in a separate file.
rm(list = ls())
library(countrycode)
library(data.table)
library(tidyverse)
...
ggplot2::ggsave(plot = replication_full,
                filename = "output/clustering_comparison_R_STATA.pdf", 
                width = 16, height = 6)
